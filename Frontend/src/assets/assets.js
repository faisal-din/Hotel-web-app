...
export const testimonials = [
  {
    ...
    rating: 5,
    review:
      "I've used many booking platforms before, but none compare to the personalized experience & attention to detail that QuickStay provides.",
  },
  {
    id: 2,
    name: 'Liam Johnson',
    ...
    rating: 4,
    review:
      'QuickStay exceeded my expectations. Booking process was seamless,  hotels were absolutely top-notch. Highly recommended',
  },
  {
    id: 3,
    name: 'Sophia Lee',
